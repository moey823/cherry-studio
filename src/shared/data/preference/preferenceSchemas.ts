 ...
 * Generated at: 2026-07-17T03:26:23.234Z
 *
...
export interface PreferenceSchemas {
  default: {
    ...
    // target-key-definitions/complex/complex
    'agent.session.sort_type': PreferenceTypes.TopicSessionSortBy
    // target-key-definitions/complex/complex
    'agent.session.workdir_section_order': PreferenceTypes.AgentSessionWorkdirSection[]
    ...
    // target-key-definitions/complex/complex
    'topic.sort_type': PreferenceTypes.TopicSessionSortBy
    // target-key-definitions/complex/complex
...
export const DefaultPreferences: PreferenceSchemas = {
  default: {
    ...
    'agent.session.sort_type': 'createdAt',
    'agent.session.workdir_section_order': ['workdir', 'no-workdir'],
